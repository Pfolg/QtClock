...
class LoadedUI(QWidget):
    def __init__(self, data: {}):
        ...
        self.pushButton_font: QPushButton = ui.pushButton
        self.pushButton_color: QPushButton = ui.pushButton_2
        self.label: QLabel = ui.label
        self.horizontalSlider_x: QSlider = ui.horizontalSlider
        self.horizontalSlider_y: QSlider = ui.horizontalSlider_2
    ...
    def change_location(self):
        ...
        root.setGeometry(*self.winLocation, 420, 0)
        self.save_data()
    ...
    def set_function(self):
        ...
        self.horizontalSlider_x.setMaximum(self.screen_geometry.width())
        self.horizontalSlider_y.setMaximum(self.screen_geometry.height())
...
def setup_clock(data: {}):
    root.setGeometry(*data.get("location"), 420, 0)  # 位置
